...
import { withFilterService } from "./FilterServiceProvider";
...
function FilterList(props) {
  ...
  const { filterData, updateData, resetFilterData } = props;
...
export default withFilterService(FilterList);
